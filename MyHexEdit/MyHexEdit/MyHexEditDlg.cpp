...
BOOL CMyHexEditDlg::OnInitDialog()
{
	...
	p1=HexEditControl::ShowHexControlEx(m_hWnd,0,0,600,40,TRUE,TRUE);
	BYTE buffer[] = {
		0x00, 0x00, 0x05, 0x03, 0x00, 0x00, 0x00, 0x0a,
		0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
		0x00, 0x0d, 0x35, 0x34, 0x33, 0x33, 0x34, 0x30,
		0x39, 0x39, 0x37, 0x00, 0x09, 0x2a, 0x2c, 0x33,
		0x00, 0x00, 0x05, 0x03, 0x00, 0x00, 0x00, 0x0a,
		0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
		0x00, 0x0d, 0x35, 0x34, 0x33, 0x33, 0x34, 0x30,
		0x39, 0x39, 0x37, 0x00, 0x09, 0x2a, 0x2c, 0x33,
	...
	HexEditControl::SetData(p1,buffer, sizeof(buffer));


	p2 = HexEditControl::ShowHexControl(this->m_hWnd,0,60,600,160);
	HexEditControl::SetData(p2, buffer, sizeof(buffer));
...
{
	// TODO:  在此添加控件通知处理程序代码
	unsigned int len = HexEditControl::GetDataLength(p1);
	BYTE *bf = new BYTE[len];
	HexEditControl::GetData(p1, bf, len);

	HexEditControl::SetData(p2, bf, len);
}
