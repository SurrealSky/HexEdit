...
//字节序转换宏
#define STswab64(x)  ((x&0x00000000000000ff << 56|((x&0x000000000000ff00) << 40)|((x&0x0000000000ff0000) << 24)|((x&0x00000000ff000000) <<  8)|((x&0x000000ff00000000) >>  8)|((x&0x0000ff0000000000) >> 24)|((x&0x00ff000000000000ULL) >> 40)|((x&0xff00000000000000ULL) >> 56)))
